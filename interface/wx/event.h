...
public:
    ...
    enum wxEventSource
    {
        /// The event source is not specified
        UNSPECIFIED = 0,

        /// The event was generated by the mouse
        MOUSE,

        /// The event was generated by the keyboard
        KEYBOARD
    };
    ...
    */
    ...
    /**
        ...
        This method will return UNSPECIFIED for all events other than EVT_MENU and
        EVT_TOOL.
    */
    wxEventSource GetEventSource() const;
    ...
    */
    ...
    /**
        Sets the source of the event. The valid options are given in wxEventSource.
    */
    void SetEventSource(wxEventSource eventSource = UNSPECIFIED);
};
